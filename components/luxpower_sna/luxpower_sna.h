...
// =========================================================================
// The Client class to handle persistent connections
// =========================================================================
class Client {
 public:
  Client() = default;
  ...
  // These are DECLARED here and DEFINED in the .cpp file.
...
#pragma pack(push, 1)
// --- YOUR ORIGINAL STRUCTS: UNCHANGED ---
struct LuxHeader {
...
struct LuxLogDataRawSection1 {
  uint16_t status; int16_t v_pv_1, v_pv_2, v_pv_3, v_bat; uint8_t soc, soh; uint16_t internal_fault;
  int16_t p_pv_1, p_pv_2, p_pv_3, p_charge, p_discharge; int16_t v_ac_r, v_ac_s, v_ac_t, f_ac, p_inv, p_rec;
  int16_t rms_current, pf; int16_t v_eps_r, v_eps_s, v_eps_t, f_eps, p_to_eps, apparent_eps_power;
  int16_t p_to_grid, p_to_user; int16_t e_pv_1_day, e_pv_2_day, e_pv_3_day, e_inv_day, e_rec_day;
  int16_t e_chg_day, e_dischg_day, e_eps_day, e_to_grid_day, e_to_user_day; int16_t v_bus_1, v_bus_2;
};
struct LuxLogDataRawSection2 {
  int32_t e_pv_1_all, e_pv_2_all, e_pv_3_all, e_inv_all, e_rec_all; int32_t e_chg_all, e_dischg_all, e_eps_all, e_to_grid_all, e_to_user_all;
  uint32_t fault_code, warning_code; int16_t t_inner, t_rad_1, t_rad_2, t_bat; uint16_t _reserved2; uint32_t uptime;
};
struct LuxLogDataRawSection3 {
  uint16_t _reserved3; int16_t max_chg_curr, max_dischg_curr, charge_volt_ref, dischg_cut_volt;
  uint8_t placeholder[20]; int16_t bat_status_inv, bat_count, bat_capacity, bat_current; int16_t reg99, reg100;
  int16_t max_cell_volt, min_cell_volt, max_cell_temp, min_cell_temp; uint16_t _reserved4;
  int16_t bat_cycle_count; uint8_t _reserved5[14]; int16_t p_load2;
};
...
struct LuxLogDataRawSection5 {
  uint8_t _reserved7[20]; int16_t p_load_ongrid, e_load_day, e_load_all_l; uint8_t _reserved8[54];
};
#pragma pack(pop)
...
class LuxpowerSNAComponent : public PollingComponent {
 public:
  ...
  // All sensor setters are unchanged
 ...
 private:
  ...
  // This is our new connection manager client
  Client client_;
  ...
  // All sensor pointers are unchanged
  text_sensor::TextSensor *lux_firmware_version_sensor_{nullptr}, *lux_inverter_model_sensor_{nullptr}, *lux_status_text_sensor_{nullptr}, *lux_battery_status_text_sensor_{nullptr}, *inverter_serial_number_sensor_{nullptr};
  sensor::Sensor *lux_current_solar_voltage_1_sensor_{nullptr}, *lux_current_solar_voltage_2_sensor_{nullptr}, *lux_current_solar_voltage_3_sensor_{nullptr}, *lux_battery_voltage_sensor_{nullptr}, *lux_battery_percent_sensor_{nullptr}, *soh_sensor_{nullptr}, *lux_internal_fault_sensor_{nullptr}, *lux_current_solar_output_1_sensor_{nullptr}, *lux_current_solar_output_2_sensor_{nullptr}, *lux_current_solar_output_3_sensor_{nullptr}, *lux_battery_charge_sensor_{nullptr}, *lux_battery_discharge_sensor_{nullptr}, *lux_grid_voltage_r_sensor_{nullptr}, *lux_grid_voltage_s_sensor_{nullptr}, *lux_grid_voltage_t_sensor_{nullptr}, *lux_grid_frequency_live_sensor_{nullptr}, *lux_grid_voltage_live_sensor_{nullptr}, *lux_power_from_inverter_live_sensor_{nullptr}, *lux_power_to_inverter_live_sensor_{nullptr}, *lux_power_current_clamp_sensor_{nullptr}, *grid_power_factor_sensor_{nullptr}, *eps_voltage_r_sensor_{nullptr}, *eps_voltage_s_sensor_{nullptr}, *eps_voltage_t_sensor_{nullptr}, *eps_frequency_sensor_{nullptr}, *lux_power_to_eps_sensor_{nullptr}, *lux_power_to_grid_live_sensor_{nullptr}, *lux_power_from_grid_live_sensor_{nullptr}, *lux_daily_solar_array_1_sensor_{nullptr}, *lux_daily_solar_array_2_sensor_{nullptr}, *lux_daily_solar_array_3_sensor_{nullptr}, *lux_power_from_inverter_daily_sensor_{nullptr}, *lux_power_to_inverter_daily_sensor_{nullptr}, *lux_daily_battery_charge_sensor_{nullptr}, *lux_daily_battery_discharge_sensor_{nullptr}, *lux_power_to_eps_daily_sensor_{nullptr}, *lux_power_to_grid_daily_sensor_{nullptr}, *lux_power_from_grid_daily_sensor_{nullptr}, *bus1_voltage_sensor_{nullptr}, *bus2_voltage_sensor_{nullptr}, *lux_current_solar_output_sensor_{nullptr}, *lux_daily_solar_sensor_{nullptr}, *lux_power_to_home_sensor_{nullptr}, *lux_battery_flow_sensor_{nullptr}, *lux_grid_flow_sensor_{nullptr}, *lux_home_consumption_live_sensor_{nullptr}, *lux_home_consumption_sensor_{nullptr}, *lux_total_solar_array_1_sensor_{nullptr}, *lux_total_solar_array_2_sensor_{nullptr}, *lux_total_solar_array_3_sensor_{nullptr}, *lux_power_from_inverter_total_sensor_{nullptr}, *lux_power_to_inverter_total_sensor_{nullptr}, *lux_total_battery_charge_sensor_{nullptr}, *lux_total_battery_discharge_sensor_{nullptr}, *lux_power_to_eps_total_sensor_{nullptr}, *lux_power_to_grid_total_sensor_{nullptr}, *lux_power_from_grid_total_sensor_{nullptr}, *lux_fault_code_sensor_{nullptr}, *lux_warning_code_sensor_{nullptr}, *lux_internal_temp_sensor_{nullptr}, *lux_radiator1_temp_sensor_{nullptr}, *lux_radiator2_temp_sensor_{nullptr}, *lux_battery_temperature_live_sensor_{nullptr}, *lux_uptime_sensor_{nullptr}, *lux_total_solar_sensor_{nullptr}, *lux_home_consumption_total_sensor_{nullptr}, *lux_bms_limit_charge_sensor_{nullptr}, *lux_bms_limit_discharge_sensor_{nullptr}, *charge_voltage_ref_sensor_{nullptr}, *discharge_cutoff_voltage_sensor_{nullptr}, *battery_status_inv_sensor_{nullptr}, *lux_battery_count_sensor_{nullptr}, *lux_battery_capacity_ah_sensor_{nullptr}, *lux_battery_current_sensor_{nullptr}, *max_cell_volt_sensor_{nullptr}, *min_cell_volt_sensor_{nullptr}, *max_cell_temp_sensor_{nullptr}, *min_cell_temp_sensor_{nullptr}, *lux_battery_cycle_count_sensor_{nullptr}, *lux_home_consumption_2_live_sensor_{nullptr}, *lux_current_generator_voltage_sensor_{nullptr}, *lux_current_generator_frequency_sensor_{nullptr}, *lux_current_generator_power_sensor_{nullptr}, *lux_current_generator_power_daily_sensor_{nullptr}, *lux_current_generator_power_all_sensor_{nullptr}, *lux_current_eps_L1_voltage_sensor_{nullptr}, *lux_current_eps_L2_voltage_sensor_{nullptr}, *lux_current_eps_L1_watt_sensor_{nullptr}, *lux_current_eps_L2_watt_sensor_{nullptr}, *p_load_ongrid_sensor_{nullptr}, *e_load_day_sensor_{nullptr}, *e_load_all_l_sensor_{nullptr};
};
