...
SENSOR_TYPES = {
    ...
    "max_cell_voltage": sensor.sensor_schema(unit_of_measurement=UNIT_MILLIVOLT, device_class=DEVICE_CLASS_VOLTAGE, state_class=STATE_CLASS_MEASUREMENT, accuracy_decimals=3),
    "min_cell_voltage": sensor.sensor_schema(unit_of_measurement=UNIT_MILLIVOLT, device_class=DEVICE_CLASS_VOLTAGE, state_class=STATE_CLASS_MEASUREMENT, accuracy_decimals=3),
